...
const store = new Vuex.Store({
  ...
  mutations: {
    setListSecondId(state, id) {
      state.list_second_id = id;
      console.warn("store second", state.list_second_id)
    },
    setThirdId(state, id) {
      state.list_third_id = id;
      console.warn("store third", state.list_third_id)
    },
    setDevelopment(state, Development) {
      state.Development = Development
    },
    setWholesaler(state, is_wholesaler) {
      state.is_wholesaler = is_wholesaler
    },
